...
/**
 * BottlePreview — the brand bottle with the customer's name on it.
 *
 * Deliberately NOT the packaging renderer. This is the welcome image on the
 * opening step, shown before anyone has chosen anything, so it stays a fixed
 * house shot and never tries to reflect the pack being configured further on.
 * That decoupling is the point: the customer is typing their name here, not
 * designing a bottle yet.
 *
